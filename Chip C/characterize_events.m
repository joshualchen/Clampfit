...
while true
    ...
    elseif value == 97
        ...
        if withinBounds(t - 0.96, 1000*structure{x, 2}, 1000*structure{x, 3})
            t = t - 0.96;
        end
        redraw(x, structure, trace, t);
    elseif value == 100
    ...
    elseif value == 119
        ...
        if withinBounds(t + t_length * 0.96, 1000*structure{x, 2}, 1000*structure{x, 3})
            t = t + t_length * 0.96;
        end
        redraw(x, structure, trace, t);
    elseif value == 115
...
function redraw(num, structure, trace, t)
    ...
    x_vals = 1000 * linspace(structure{num, 2}, structure{num, 3}, length(background)); % units in ms
